...
COM_OPEN : '<Com';
FREQUENCY : 'frequency';
/*COM_TYPE : 'APPROACH' | 'ASOS' | 'ATIS' | 'AWOS' | 'CENTER' | 'CLEARANCE' | 'CLEARANCE_PRE_TAXI' | 'CTAF' |
'DEPARTURE'
         | 'FSS' | 'GROUND' | 'MULTICOM' | 'REMOTE_CLEARANCE_DELIVERY' | 'TOWER' | 'UNICOM';

/****TaxywayPoint****/
TAXIWAY_POINT_OPEN : '<TaxiwayPoint';
// : 'NORMAL' | 'HOLD_SHORT' | 'ILS_HOLD_SHORT' | 'HOLD_SHORT_NO_DRAW' | 'ILS_HOLD_SHORT_NO_DRAW';
...
//TAXI_PATH_TYPE :  'RUNWAY' | 'TAXI' | 'PATH' | 'CLOSED' | 'VEHICLE' ; //TODO implementar especificidade do numero se
//RUNWAY
...
fuelAvailability
    ...
    : AVAILABILITY EQUAL QUOTE ( BOOLEAN2 | STRING ) QUOTE
    ;
